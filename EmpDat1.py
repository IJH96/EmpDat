...
def printPeople():
    ...
    for employee in people:
            f.write(str(employee.position) + " " + str(employee.fname) + " " + str(employee.lname) + " " + str(employee.age) + " " + str(employee.salary) + "\n")
